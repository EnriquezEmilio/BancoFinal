...
namespace Banco.Data
{
    public class MiContexto : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Usuario>(
                user =>
                {
                    ...
                    user.Property(u => u.password).HasColumnType("varchar(100)");
            ...
            modelBuilder.Entity<CajaDeAhorro>(
                caja =>
                {
                    ...
                    caja.Property(c => c.TitularNombre).HasColumnType("nvarchar(50)");
                    caja.Property(c => c.TitularNombre).IsRequired(false);
                    caja.Property(c => c.TitularApellido).HasColumnType("nvarchar(50)");
                    caja.Property(c => c.TitularApellido).IsRequired(false);
                });
            ...
            modelBuilder.Entity<Usuario>()
            .HasData(
                new { id = 1, dni=1234, nombre="Matias", apellido= "Suarez", mail= "matias@suarez", 
                    password="111", intentosFallidos=0, bloqueado=false, isAdmin=true },
                new { id = 2, dni = 1235, nombre = "Emilio", apellido = "Enriquez", mail = "emilio@enriquez",
                    password = "111", intentosFallidos = 0, bloqueado = false, isAdmin = true },
                new { id = 3, dni = 1236, nombre = "Marcos", apellido = "Lacoa", mail = "marcos@lacoa",
                     password = "111", intentosFallidos = 0, bloqueado = false, isAdmin = true },
                new {  id = 4 , dni = 1237,  nombre = "Agustin",  apellido = "Arrojo",   mail = "agustin@arrojo",
                     password = "111",  intentosFallidos = 0,  bloqueado = false,  isAdmin = true}
        ...
        public DbSet<Banco.Models.UsuarioCaja> UsuarioCaja { get; set; }
    }
}
